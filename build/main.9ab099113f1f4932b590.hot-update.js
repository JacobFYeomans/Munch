...
class Bug extends Character_1.Character {
    ...
    update() {
        ...
        if (this._state == Character_1.Character.STATE_IDLE)
            return;
        if (this.sprite.x >= this.stage.getBounds().width + this.sprite.getBounds().width || this.sprite.x <= 0 - this.sprite.getBounds().width)
            ;
    }
}
exports.Bug = Bug;
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("3d16b2db9d1527276109")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.9ab099113f1f4932b590.hot-update.js.map